...
fn lsp_action_from_str_all_aliases() {
    ...
    let cases = [
        ...
        ("code_action", Some(LspAction::CodeAction)),
        ("codeaction", Some(LspAction::CodeAction)),
        ("rename", Some(LspAction::Rename)),
        ("signature_help", Some(LspAction::SignatureHelp)),
        ("signatures", Some(LspAction::SignatureHelp)),
        ("code_lens", Some(LspAction::CodeLens)),
        ("codelens", Some(LspAction::CodeLens)),
        ("workspace_symbols", Some(LspAction::WorkspaceSymbols)),
        ("unknown", None),
    ];
